      ...
      <div className="w-full">
        ...
        {status === "loading" && (
          <div className="text-center">
            <div className="mx-auto mb-6 flex h-20 w-20 animate-spin items-center justify-center rounded-full border-4 border-violet-200 border-t-violet-600" />
        ...
        {status === "success" && (
          <div className="text-center">
            ...
            <div className="mt-5 rounded-2xl bg-violet-50 px-4 py-3 text-sm text-violet-700">
              Redirecting to login in <span className="font-bold">{countdown}</span>s...
            </div>
            <Button as={Link} to="/login" className="mt-4 w-full py-3.5">
              Go to Login Now
            </Button>
          </div>
        )}
        ...
        {status === "error" && (
          <div className="text-center">
            ...
            <Button as={Link} to="/login" className="mt-8 w-full py-3.5">
              Back to Login
            </Button>
          </div>
        )}
