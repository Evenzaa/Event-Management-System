                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6">
                ...
                
                    {
                        ...
                        datareview?.data?.length > 0 ? (
                            datareview?.data?.map((user)=>(

                            <div className="w-full bg-white border-b border-[#E5E7EB] rounded-xl p-6 mt-7 flex flex-col sm:flex-row gap-5"
                                key={user._id}
                            >
                            ...
                            <div className="w-full bg-white border border-[#E5E7EB] rounded-xl p-8 sm:p-12 mt-7 flex flex-col items-center justify-center gap-3 text-center">
                                ...
                                <span className="text-base text-[#6b7280] font-medium">
                                    {eventId ? "This event hasn't received any reviews yet."
