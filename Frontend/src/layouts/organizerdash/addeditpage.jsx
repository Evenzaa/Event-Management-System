...
import { Modal, Form, Input,  Button,Select, Upload,Image, message,DatePicker, TimePicker} from "antd";
                ...
                >
                    <div className="px-2 sm:px-4">
                        <Form
                            ...
                            layout="vertical"
                            onSubmitCapture={(e) => {
                                console.log("Submit event", e.nativeEvent.submitter);
                            }}
                            onFinish={onFinish}
                            preserve
                        ...
                        >
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4">
                                        ...
                                        {/* <span className="block mb-2 text-[15px] font-semibold">Date</span> */}
                                            <div className="flex flex-col sm:flex-row gap-4">
                                                ...
                                                <div className="w-full md:w-1/2">
                                                    <span className="block mb-2 text-[15px] font-semibold">Time</span>
                            ...
                            <div className="flex flex-col-reverse sm:flex-row gap-3 justify-between mt-8">
                                ...
                                htmlType="button"
                                    ...
                                    className="w-full sm:w-auto !h-10 !rounded-lg !text-lg"
